...
export default {
  ...
  'menu.dashboard.workplace': '工作台1111',
  'menu.form': '表单页',
  ...
  'menu.数据中心': '数据中心',
  'menu.数据中心.测序仪': '测序仪',
  'menu.datacenter.sequencer': '测序仪',
  'menu.数据中心.下机批次': '下机批次',
  'menu.datacenter.batch': '下机批次',
  'menu.数据中心.样本表': '样本表',
  'menu.datacenter.samplesheet': '样本表',
  'menu.数据中心.样本': '样本',
  'menu.datacenter.sample': '样本',
  'menu.数据中心.rawfq 文件': 'rawfq文件',
  'menu.datacenter.samplefile': 'rawfq文件',
  // 项目管理
  'menu.项目管理': '项目管理',
  'menu.项目管理.项目列表': '项目列表',
  // 'menu.datacenter.batch.batch': '测试页',
  // 生信开发 系统管理  分析工具
  'menu.生信开发':'生信开发',
  'menu.生信开发.docker镜像':'docker镜像',
  'menu.生信开发.工具':'工具',
  'menu.生信开发.工作流':'工作流',
  'menu.系统管理':'系统管理',
  'menu.系统管理.后台菜单':'后台菜单',
  ...
  // 权限管理
  'menu.账号权限管理': '账号权限管理',
  'menu.账号权限管理.用户管理': '用户管理',
  'menu.账号权限管理.角色管理': '角色管理',
  'menu.账号权限管理.权限管理': '权限管理',
  'menu.账号权限管理.权限组管理': '权限组管理',

  //耗材
  'menu.category.center': '耗材管理',
  'menu.耗材管理': '耗材管理',
  'menu.耗材管理.耗材属性': '耗材属性',
